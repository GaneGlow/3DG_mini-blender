    ...
    public static void render(
        ...
        for (SceneObject sceneObject : sceneObjects) {
            ...
            for (Polygon polygon : mesh.polygons) {
                ...
                if (objectSettings.useTexture && texture != null &&
                ...
                } else if (objectSettings.useLighting && polygon.getNormalIndices().size() == 3) {
                    ...
                    Color c1 = Lighting.applySmoothLighting(baseColor, transformedN1, light);
                    Color c2 = Lighting.applySmoothLighting(baseColor, transformedN2, light);
                    Color c3 = Lighting.applySmoothLighting(baseColor, transformedN3, light);
