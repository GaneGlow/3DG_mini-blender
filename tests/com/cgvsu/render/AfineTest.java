...
class AfineTest {
    ...
    public void testDefaultConstructor() {
        Vector3 expectedTranslation = new Vector3(0, 0, 0);
        Vector3 expectedRotation = new Vector3(0, 0, 0);
        Vector3 expectedScale = new Vector3(1, 1, 1);
    ...
    public void testSetAndGetTranslation() {
        Vector3 newTranslation = new Vector3(10.5f, -3.2f, 7.8f);
        transform.setTranslation(newTranslation);

        Vector3 actualTranslation = transform.getTranslation();
        assertVectorsEqual(newTranslation, actualTranslation, "Translation should be set correctly");
    }

    @Test
    public void testSetAndGetRotation() {
        Vector3 newRotation = new Vector3((float) Math.PI/2, (float) Math.PI/4, (float) Math.PI/6);
        transform.setRotation(newRotation);

        Vector3 actualRotation = transform.getRotation();
        assertVectorsEqual(newRotation, actualRotation, "Rotation should be set correctly");
    }

    @Test
    public void testSetAndGetScale() {
        Vector3 newScale = new Vector3(2.0f, 0.5f, 3.0f);
        transform.setScale(newScale);

        Vector3 actualScale = transform.getScale();
    ...
    public void testTranslatePositiveValues() {
        ...
        Vector3 expected = new Vector3(5.0f, 3.0f, 2.0f);
    ...
    public void testTranslateNegativeValues() {
        ...
        Vector3 expected = new Vector3(-2.0f, -5.0f, -1.0f);
    ...
    public void testRotateNegativeValues() {
        ...
        Vector3 expected = new Vector3(-0.3f, -0.7f, -1.2f);
    ...
    public void testScaleUniform() {
        ...
        Vector3 expected = new Vector3(2.0f, 2.0f, 2.0f);
    ...
    public void testScaleUniformMultipleTimes() {
        ...
        Vector3 expected = new Vector3(3.0f, 3.0f, 3.0f); // 2.0 * 1.5 = 3.0
    ...
    public void testScaleX() {
        ...
        Vector3 expected = new Vector3(2.0f, 1.0f, 1.0f);
    ...
    public void testScaleY() {
        ...
        Vector3 expected = new Vector3(1.0f, 0.5f, 1.0f);
    ...
    public void testScaleCombinedAxes() {
        ...
        transform.scaleY(0.5f);
        transform.scaleZ(3.0f);
        Vector3 expected = new Vector3(2.0f, 0.5f, 3.0f);
    ...
    public void testReset() {
        ...
        transform.setTranslation(new Vector3(10, 20, 30));
        transform.setRotation(new Vector3(1, 2, 3));
        transform.setScale(new Vector3(5, 6, 7));
    ...
    public void testAllTransformationsCombined() {
        ...
        // Проверяем перевод
        Vector3 expectedTranslation = new Vector3(10, 5, 3);
        assertVectorsEqual(expectedTranslation, transform.getTranslation(), "Translation should be correct");

        // Проверяем вращение
        Vector3 expectedRotation = new Vector3((float)Math.PI/4, (float)Math.PI/3, 0);
        ...
        Vector3 expectedScale = new Vector3(1.0f, 0.75f, 0.5f); // X: 2*0.5=1, Y: 1.5*0.5=0.75, Z: 1*0.5=0.5
    ...
    public void testScaleWithZeroFactor() {
        ...
        transform.scaleX(2.0f);
        Vector3 expectedAfter = new Vector3(0.0f, 0.0f, 0.0f); // 0 * 2 = 0
    ...
    public void testScaleWithNegativeFactor() {
        ...
        Vector3 expectedAfter = new Vector3(1.0f, 1.0f, 1.0f); // -2 * -0.5 = 1
    ...
    private void assertVectorsEqual(Vector3 expected, Vector3 actual, String message) {
